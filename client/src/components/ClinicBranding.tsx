...
interface ClinicBrandingData {
  ...
  videoNarrationLanguage?: string
  generateVideosAutomatically?: boolean
  treatmentDurationThreshold?: number
  timezone?: string
}
      ...
      <div style="background-color: #f8f9fa; padding: 30px 20px; margin-top: 40px; border-top: 3px solid ${brandingData.primaryColor};">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 20px;">
          <div style="flex: 1; min-width: 200px;">
            ...
            <div style="color: ${brandingData.secondaryColor}; font-size: 14px; line-height: 1.6;">
              ${brandingData.address ? `<p style="margin: 2px 0;">${brandingData.address}</p>` : ''}
              ${brandingData.phone ? `<p style="margin: 2px 0;">${brandingData.phone}</p>` : ''}
              ${brandingData.email ? `<p style="margin: 2px 0;">${brandingData.email}</p>` : ''}
              ${brandingData.website ? `<p style="margin: 2px 0;">${brandingData.website}</p>` : ''}
            </div>
          </div>
          <div style="text-align: center;">
            ${brandingData.website ? `
              <a href="${brandingData.website.startsWith('http') ? brandingData.website : 'https://' + brandingData.website}" style="background-color: ${brandingData.primaryColor}; color: white; padding: 12px 24px; border: none; border-radius: 6px; font-size: 16px; text-decoration: none; display: inline-block;">
            ...
            <p style="margin: 10px 0 0 0; font-size: 12px; color: ${brandingData.secondaryColor};">
              Generated by Scanwise AI • {{REPORT_DATE}}
            </p>
          </div>
        </div>
