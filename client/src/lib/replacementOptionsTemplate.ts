      ...
      <table style="width:100%;border-collapse:collapse;border-radius:8px;overflow:hidden;">
        <thead>
          <tr style="background-color:#ffffff;">
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;width:140px;">Treatment</th>
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;">What it is</th>
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;">Estimated Cost</th>
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;">Pros</th>
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;">Cons</th>
            <th style="padding:12px;border:1px solid #dee2e6;text-align:left;">Recovery Experience</th>
          </tr>
        </thead>
        <tbody>
          <tr style="background-color:#ffffff;">
            <td style="padding:12px;border:1px solid #dee2e6;border-left:4px solid #0d6efd;">
              <strong>🦷 Dental Implant</strong>
              ${getRecommendationBadge('implant-placement')}
            </td>
            <td style="padding:12px;border:1px solid #dee2e6;">${info.implantDesc}</td>
            <td style="padding:12px;border:1px solid #dee2e6;"><span style="background-color:#d4edda;color:#155724;padding:4px 10px;border-radius:20px;">$${implantPrice}</span></td>
          ...
          <tr style="background-color:#ffffff;">
            ...
            <td style="padding:12px;border:1px solid #dee2e6;">${info.bridgeDesc}</td>
            <td style="padding:12px;border:1px solid #dee2e6;"><span style="background-color:#d4edda;color:#155724;padding:4px 10px;border-radius:20px;">$${bridgePrice}</span></td>
            <td style="padding:12px;border:1px solid #dee2e6;">
              <ul style="padding-left:18px;margin:0;">
                <li>Non-surgical</li>
          ...
          <tr style="background-color:#ffffff;">
            ...
            <td style="padding:12px;border:1px solid #dee2e6;">${info.dentureDesc}</td>
            <td style="padding:12px;border:1px solid #dee2e6;"><span style="background-color:#d4edda;color:#155724;padding:4px 10px;border-radius:20px;">$${denturePrice}</span></td>
            <td style="padding:12px;border:1px solid #dee2e6;">
              <ul style="padding-left:18px;margin:0;">
                <li>Affordable</li>
