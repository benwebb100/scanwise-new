...
export function StageEditor({ 
  ...
  return (
    <div className="flex flex-col h-full max-h-[90vh] bg-gradient-to-br from-blue-50 to-indigo-50">
      {/* Header */}
      <div className="flex-shrink-0 p-6 border-b bg-white shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              Treatment Stage Editor
            </h2>
            <p className="text-gray-600 mt-2 text-base">
              Use arrow buttons to move treatments between stages and organize your treatment plan
            </p>
          </div>
        ...
        {/* Global totals */}
        <Card className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 border-0 shadow-lg">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                  ...
                  <div>
                    <span className="text-white/80 text-sm block">Total Cost</span>
                    <span className="text-xl font-bold text-white">
              ...
              {isDirty && (
                <Badge className="bg-orange-500 text-white border-0 text-sm px-3 py-1 shadow-md">
