    ...
    try {
      ...
      if (useXrayMode) {
        ...
        if (finalReport && finalReport.trim().length > 0) {
          ...
          // Switch to report tab to show the generated report
          setActiveTab('report');
          console.log('🚀 REPORT GENERATION: Switched to report tab');
        } else {
        ...
        if (finalReport && finalReport.trim().length > 0) {
          ...
          // Switch to report tab to show the generated report
          setActiveTab('report');
          console.log('🚀 REPORT GENERATION: Switched to report tab (no xray)');
        } else {
